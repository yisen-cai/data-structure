...
/**
 * Move index i to the latter, check whether former substring  contains
 * duplicate character Time complexity: O(n^2)
 * @param s
 * @return
 */
...
/**
 * Method: Generate all the substring of the input string s, and then check
 * whether the substring contains duplicate Time complexity: O(n^3)
 */
