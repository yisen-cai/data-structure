...
class ConstRef {
 ...
 private:
  // the initialization order depend on the order they are defined under the
  // class definition, not the constructor initializers order
  int i;
  const int ci;
  int &ri;
};
