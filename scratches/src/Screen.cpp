...
char Screen::get(Screen::pos ht, Screen::pos wd) const { return 0; }

Screen &Screen::move(Screen::pos r, Screen::pos c) { return *this; }

void Screen::increAccessCtr() const { ++accessCtr; }
...
Screen &Screen::display(std::ostream &os) { return *this; }
...
Screen::Screen(Screen::pos h, Screen::pos w)
